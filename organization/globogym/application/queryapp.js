...
async function main() {
    ...
    try {
        ...
        // 2 ownership query
        console.log('2. Query Gym Plan Ownership.... Papers owned by UniversalHealth');
        console.log('-----------------------------------------------------------------------------------------\n');
        ...
        console.log('5. Named Query:.... All papers in org.gymplannet.plans with faceValue > 4000000');
        console.log('-----------------------------------------------------------------------------------------\n');
