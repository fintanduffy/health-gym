 ...
 * 4. Construct request to buy (buy_request) gym plan
...
async function main () {
    ...
    try {
        ...
        // request to buy gym plan using buy_request / transfer two-part transaction
        console.log('Submit gym plan buy_request transaction.');

        const buyResponse = await contract.submitTransaction('buy_request', 'UniversalHealth', '00001', 'UniversalHealth', 'GloboGym', '4900000', '2020-05-31');
        ...
        console.log(`${plan.issuer} gym plan : ${plan.planNumber} has been provisionally purchased : the transfer must now be completed by gym plan owner`);
