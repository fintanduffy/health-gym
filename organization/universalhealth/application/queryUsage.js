...
async function main() {
    ...
    try {
        ...
        // gym usage asset history
        console.log('1. Query Gym Plan Usage History....');
        console.log('-----------------------------------------------------------------------------------------\n');
        let queryResponse1 = await contract.evaluateTransaction('queryHistoryUsage', 'UniversalHealth', '00001', 'GloboHealth', 'Gordon', 'org.gymplannet.gymplanusage');

        json = JSON.parse(queryResponse1.toString());
        console.log(json);
        console.log('\n\n');
